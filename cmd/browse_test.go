...
func TestBuildBrowseURL(t *testing.T) {
	cases := []struct {
		...
		{"github branch+path", "github", "github.com", "owner/repo", "main", "", "src/foo.go", 0,
			"https://github.com/owner/repo/blob/main/src/foo.go"},
		{"github branch+path with spaces", "github", "github.com", "owner/repo", "main", "", "src/my file.go", 0,
			"https://github.com/owner/repo/blob/main/src/my%20file.go"},
		...
		{"gitlab branch+path", "gitlab", "gitlab.com", "group/repo", "main", "", "lib/a.rb", 0,
			"https://gitlab.com/group/repo/-/blob/main/lib/a.rb"},
