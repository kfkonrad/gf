...
var cases = []tcase{
	...
	{"github", "repo", "browse", ss("repo", "view", "--web"), false, false},
	...
	{"gitlab", "repo", "browse", ss("repo", "view", "--web"), false, false},
	...
	// structural exception: tea open is top-level, DropArgs=true
	{"gitea", "repo", "browse", ss("open"), true, false},
